(function(global, factory) {
  ...
  const T = {
    ...
    parse: (t, e, s2) => {
      ...
      return typeof c == "function" ? c.bind(s2) : void 0;
    }
  }, $ = {
  ...
  function _(t, e, s2) {
    ...
    const c = Array.isArray(e.props) ? e.props.slice() : Object.keys(e.props), b = {}, m2 = {}, w = {};
    for (const r of c) {
    ...
    class S extends HTMLElement {
      constructor() {
        ...
        for (const n of c) {
          const f2 = m2[n], o2 = this.getAttribute(f2), i2 = b[n], a2 = i2 ? A[i2] : null;
  ...
  function f(t, e, r) {
    const n = createRoot(t), u = o.createElement(e, r);
    return n.render(u), {
      root: n,
      ReactComponent: e
    };
  ...
  function requireReactJsxRuntime_production_min() {
    ...
    var f2 = o, k = Symbol.for("react.element"), l2 = Symbol.for("react.fragment"), m2 = Object.prototype.hasOwnProperty, n = f2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p2 = { key: true, ref: true, __self: true, __source: true };
    function q(c, a2, g2) {
  ...
  const TextField = ({ label, type = "text", name, value, onValueChange, placeholder }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", htmlFor: name, children: label }),
  ...
  const TextFieldWC = s(TextField, {
    props: { label: "string", type: "string", name: "string", value: "string", onValueChange: "function", placeholder: "string" }
  });
